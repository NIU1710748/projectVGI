...
float cam_Esferica[3] = { 60.0f, 0.0f, 0.0f }; // ImGui: Coordenades Esfèriques Càmera
...
// --- VAO simple para la habitación (cubo interior) --- //popo
struct MeshSimple {
...
void CreateHabitacioVAO(float halfX = 4.0f, float halfZ = 3.0f, float height = 3.0f);
...
// Entorn VGI: Control de l'EVENT JOYSTICK / GAMEPAD
